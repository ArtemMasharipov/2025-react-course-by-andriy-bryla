...
import { selectAddPostStatus, selectUpdatePostStatus } from '../model/selectors'
import { addPostThunk, updatePostThunk } from '../model/thunks'

export const PostForm = ({ postId = null, initialData = null }) => {
