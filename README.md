# React JS Course – Homework Repository

This repository contains all homework assignments completed during the **React JS Course by Andriy Bryla (2025)**.  
Each lesson builds on previous concepts, gradually introducing advanced patterns, state management solutions, and full-stack integrations with modern best practices.
...
**Lesson 1:** 5 interactive JS/React tasks – calculators, random generators, seasonal UI, and managers.  
**Lesson 2:** 6 practice apps – form validation, CRUD operations, API integration, drag & drop.  
**Lesson 3:** React Hooks (useRef, useEffect) – timers, form handling, cleanup patterns.  
**Lesson 4:** Components practice – messenger app, number guessing game.  
**Lesson 6:** Performance optimization – memoization, virtualization, debouncing.  
**Lesson 7:** Full-stack e-commerce app – product catalog, state machines, professional responsive UI.  
**Lesson 8:** Teachers & Meetings app – teachers CRUD, meeting management, optimistic UI.  
...
**Lesson 18:** Firebase E-Commerce Platform – comprehensive e-commerce application with Firebase Firestore, user authentication, role-based access control, product management, shopping cart, favorites system, and internationalization support.
...
* `/hw-lesson-18/` – Firebase E-Commerce Platform
...
**Course Status:** ✅ Completed – 18 lessons finished  
**Final Project:** Firebase E-Commerce Platform with React 19, Redux Toolkit, and Firebase  
**Technologies Mastered:** React 19, Redux Toolkit, RTK Query, Context API, Node.js, Express, MongoDB, Firebase, Feature-Sliced Design, JWT Authentication, E-Commerce Development
