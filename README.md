...
| --------- | --------------------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Lesson 1  | JavaScript/React Tasks                                    | HTML5, CSS3, JS ES6+, React 18                                     | :globe_with_meridians: [View Demo](https://artemmasharipov.github.io/2025-react-course-by-andriy-bryla/hw-lesson-1/src/) |
| Lesson 2  | Modern React Practice                                     | React 18, Vite, Modern Hooks                                       | :globe_with_meridians: [View Demo](https://hw-lesson-2.vercel.app/)                                                      |
...
**Homework 12:** Feature-Sliced Design architecture and advanced full-stack development completed
...
- Full-Stack Posts Management App (React 19 + Express 5 + MongoDB)
- Performance Optimization (React.memo, useMemo, useCallback, lazy loading)
- Professional UI/UX (Responsive design, loading states, error boundaries)
- Database Integration with Mongoose ODM
- RESTful API Design with proper validation
- Clean Code Principles (Removed redundant comments, consistent styling)
...
- `/hw-lesson-12/` - Twelfth homework with Feature-Sliced Design architecture and full-stack posts management
...
- **API:** Axios with interceptors, RESTful design, data validation
- **Features:** Full-stack CRUD, pagination, infinite scroll, optimistic updates, error boundaries
